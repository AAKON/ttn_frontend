    ...
    return (
        <CustomStackFullWidth
            sx={{
                ...
                marginTop:
                    scrollPosition <= threshold ? '0px' : isSmall && '30px',
            }}
        >
            <CustomStackFullWidth
                sx={{
            ...
            >
                <CustomImageContainer
                    ...
                    // src="https://images.pexels.com/photos/17419698/pexels-photo-17419698.jpeg"
                ...
                <CustomStackFullWidth
                    sx={{
                        position: 'absolute',
                        background: alpha(theme.palette.neutral[100], 0.9),
                        height: '100%',
                    }}
                >
