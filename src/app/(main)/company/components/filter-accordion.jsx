        ...
        <div className="py-5 px-6">
          ...
          >
            ...
            <SelectContent className="text-gray-500">
              {filterOptions && filterOptions?.locations && filterOptions?.locations.map((location) => (
        ...
        <Accordion type="single" collapsible>
          ...
          <AccordionItem value="category" className="py-5 px-6">
            ...
            <AccordionContent className="space-y-4">
              {filterOptions && filterOptions?.categories && filterOptions?.categories.map((category) => (
          ...
          <AccordionItem value="manpower" className="py-5 px-6">
            ...
            <AccordionContent className="space-y-4">
              {filterOptions && filterOptions?.size && filterOptions?.size.map((size, index) => (
