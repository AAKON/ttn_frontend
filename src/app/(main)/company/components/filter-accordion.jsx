		...
		<div>
			<div className="border border-gray-200 rounded-[8px]">
				...
				<div className="py-3 sm:py-5 px-6">
					...
					<Select
						onValueChange={(value) => onFilterChange("locationId", value, true)}
					...
					>
						...
						<SelectContent className="text-gray-500 max-h-[200px] overflow-y-auto">
									...
									<div className="grid grid-cols-1" key={type.id}>
										<div className="flex items-center space-x-2">
											<Checkbox
												...
												onCheckedChange={(isChecked) =>
													onFilterChange("businessTypeIds", type.id, isChecked)
												}
											/>
											<label
									...
									<div className="grid grid-cols-1" key={certificate.id}>
										<div className="flex items-center space-x-2">
											<Checkbox
												...
												className="h-4 w-4 p-2 border-gray-400 border bg-white text-gray-500"
												checked={filters.certificateIds.includes(
													certificate.id
												)}
												onCheckedChange={(isChecked) =>
													onFilterChange(
