...
function ReportContent() {
    return (
        <div className="flex gap-2">
            ...
            <Checkbox id="terms1" className="px-0 py-0 h-4 w-4 bg-transparent border-gray-400 data-[state=checked]:bg-transparent data-[state=checked]:text-black data-[state=checked]:text-xs" />
