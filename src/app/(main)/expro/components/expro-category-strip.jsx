  ...
  return (
    <div className="mt-8 md:mt-12">
      <div className="relative">
        ...
        >
          <div className="flex min-w-max items-center gap-8 px-14 py-3 md:gap-10 md:px-16">
            {categories.map((category, index) => {
              ...
              return (
                <button
                  key={`${category}-${index}`}
                  type="button"
                  className={`!rounded-none !bg-transparent !px-0 !py-0 whitespace-nowrap border-b-[3px] !text-[16px] !leading-none transition-colors ${
                    isActive
                      ? "pb-[20px] border-[#111827] !font-semibold !text-[#111827]"
                      : "pb-[10px] border-transparent !font-medium !text-[#667085] hover:!text-[#111827]"
                  }`}
                >
                  {category}
                </button>
