        ...
        >
            ...
            <div className="mb-4">
                ...
                <Input
                    ...
                    className="mt-1 block w-full border border-gray-300 rounded-md px-2 py-2 focus-visible:ring-0  focus-visible:ring-offset-0"
            ...
            <div className="mb-4 flex space-x-4">
                ...
                <div className="flex-1">
                    ...
                    <Input
                        ...
                        className="w-full border border-gray-300 px-3 py-2 rounded-md focus-visible:ring-0  focus-visible:ring-offset-0"
                    />
                </div>
            ...
            <div className="mb-4">
                ...
                <Textarea
                    ...
                    onChange={handleChange}
                    className="mt-1 block w-full h-[140px] border resize-none border-gray-300 rounded-md px-2 pt-2 focus-visible:ring-0  focus-visible:ring-offset-0"
