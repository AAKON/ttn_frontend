...
export default function Register() {
    ...
    const cards = [
        { icon: '/icons/briefcase.svg', title: "I'm a seller, selling apparel items", component: <Seller /> },
        { icon: '/icons/cart.svg', title: "I’m a buyer, looking for manufaturers", component: <Buyer /> },
        { icon: '/icons/light.svg', title: "I’m a talent, looking for opportunities ", component: <Talent /> },
    ];
            ...
            <div className="auth-wrap flex flex-col justify-center items-center">
                ...
                <div className="w-full pb-20">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 md:gap-10 py-6 sm:py-8 md:py-10">
                        {cards.map((card, index) => (
                            <Card
                                ...
                                } ${index !==0 ? 'pointer-events-none cursor-not-allowed opacity-25' : ''}`}
                                    ...
                                    <div className="flex items-stretch">
                                        <div className="h-[100px] sm:h-[144px] md:h-[125px]">
                                            <div className="h-full pt-3 sm:pt-4 flex flex-col justify-between">
                                                <Image src={card.icon} width={32} height={32} alt="icon" />
                                                <p className="text-[#101828] text-base sm:text-lg md:text-xl font-medium">{card.title}</p>
                                            </div>
                                        </div>
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <Button className="mt-2 min-w-[155px]" type="submit"
