                    ...
                    <form onSubmit={form.handleSubmit(handleSubmit)}>
                        <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input
                                                ...
                                                placeholder="Kang the conquerer" {...field} />
                                        </FormControl>
                                        <FormMessage/>
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        <FormLabel className="afrm-label">Job title</FormLabel>
                                        <FormControl>
                                            <Input
                                                className="text-[#667085] focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-0 outline-0"
                                                placeholder="Designation name" {...field} />
                                        </FormControl>
                                        <FormMessage/>
                                    </FormItem>
                                )}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    render={({field}) => (
                                        <FormItem>
                                            ...
                                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="manufacturing">Australia</SelectItem>
                                                    <SelectItem value="test">Bangladesh</SelectItem>
                                                    <SelectItem value="test2">USA</SelectItem>
                                                </SelectContent>
                                            </Select>
                                            <FormMessage/>
                                        </FormItem>
                                ...
                                <FormField
                                    ...
                                    render={({field}) => (
                                        <FormItem>
                                            <FormLabel className="afrm-label">WhatsApp/Phone</FormLabel>
                                            <FormControl>
                                                <Input
                                                    className="text-[#667085] focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-0 outline-0"
                                                    placeholder="+880239484954" {...field} />
                                            </FormControl>
                                            <FormMessage/>
                                        </FormItem>
                                    )}
