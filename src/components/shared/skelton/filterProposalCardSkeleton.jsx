...
function FilterProposalCardSkeleton(props) {
    return (
        <div className="mt-8">
            <div className="grid gap-3 lg:gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
...
export default FilterProposalCardSkeleton;