const Button = ({
  ...
  return (
    <TagName
      className={`group transition-all flex items-center gap-2 justify-center rounded-[8px] px-4 py-[9px] text-md leading-[24px] font-semibold h-9 lg:h-11 ${className} ${dynamicClasses}`}
      {...props}
    >
      {icon && (
        <svg
