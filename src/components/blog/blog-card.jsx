    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
                ...
                <h3 className="py-2">
                    <Link href={`/blog/${slug}`} className="font-semibold cursor-pointer hover:underline min-[1300px]:text-2xl text-base lg:text-xl text-gray-900">
                        {title}
                    </Link>
                </h3>
                ...
                <div className="pt-4 lg:pt-6 flex items-center gap-x-6">
                    <div className="flex items-center gap-2">
                        <UserEdit />
                        <h2 className="text-sm font-semibold text-gray-600">{blog_topics?.name}</h2>
                    </div>
                    <div className="flex items-center gap-2">
                        <Calender />
