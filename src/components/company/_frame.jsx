...
const Frame = ({slug, headerData, is_favorite, className}) => {
    ...
    return (
        <div className={`relative ${className}`}>
            ...
            <Container>
                <div
                    className="bg-white border border-gray-100 p-8 rounded-2xl -mt-[140px] grid grid-cols-1 gap-8 xl:gap-12">
                  ...
                  /> */}
                    ...
                    <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
                        <LdtCard icon={<GridIcon/>} text={"Category"} categories={categories}/>
                        <LdtCard
...
// LTD Card
export function LdtCard({icon, text, title, categories, ExtSrc}) {
    return (
