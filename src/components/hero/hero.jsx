...
// label text
export function Tags({ tagText, outline=false }) {
  return (
    <div className={outline ? "text-sm flex gap-[6px] items-center rounded-md border border-gray-300 px-[14px] py-2 text-gray-900 bg-transparent" : "text-sm flex gap-[6px] items-center rounded-md border-border px-[14px] py-2 text-white bg-black/20"}>
      <span>
        <svg
          width={17}
          height={18}
